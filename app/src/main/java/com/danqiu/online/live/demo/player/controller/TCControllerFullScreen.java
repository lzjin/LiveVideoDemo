package com.danqiu.online.live.demo.player.controller;
...
import com.danqiu.online.live.demo.player.utils.TCTimeUtil;
import com.danqiu.online.live.demo.player.utils.TCVideoGestureUtil;
import com.danqiu.online.live.demo.player.view.TCPointSeekBar;
import com.danqiu.online.live.demo.player.view.TCVideoProgressLayout;
import com.danqiu.online.live.demo.player.view.TCVodMoreView;
import com.danqiu.online.live.demo.player.view.TCVodQualityView;
import com.danqiu.online.live.demo.player.view.TCVolumeBrightnessProgressLayout;
...
public class TCControllerFullScreen extends RelativeLayout implements IController, View.OnClickListener,
    ...
    private void toggleDanmu() {
        mDanmuOn = !mDanmuOn;
        if (mDanmuOn) {
            mIvDanmu.setImageResource(R.mipmap.ic_danmuku_on);
        } else {
            mIvDanmu.setImageResource(R.mipmap.ic_danmuku_off);
        }
        if (mControllerCallback != null) {
